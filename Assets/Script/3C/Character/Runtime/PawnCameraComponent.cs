...
namespace CGame
{
    ...
    {
        private const float headCameraForwardOffset = 0.14f;
        ...
        private void Tick(float deltaTime)
        {
            ...
            Vector3 cameraPosition = cameraParent != null && cameraParent.name == "Head"
                ? cameraParent.position + pawn.ControlRotation * Vector3.forward * headCameraForwardOffset
                : pawn.Transform.position + Vector3.up * 1.6f;
            camera.transform.SetPositionAndRotation(cameraPosition, pawn.ControlRotation);
        }
    }
}
