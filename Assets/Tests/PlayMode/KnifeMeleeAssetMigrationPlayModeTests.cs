...
{
    public sealed class KnifeMeleeAssetMigrationPlayModeTests
    {
        ...
        [UnityTest]
        public IEnumerator FixedCamera_CapturesMigratedKnifeAcceptanceSet()
        {
            GameObject prefab =
                AssetDatabase.LoadAssetAtPath<GameObject>(CharacterPrefabPath);
            AvatarMask upperBodyMask =
            ...
            var controller =
                new CharacterPlayablesController(animator, upperBodyMask);
            var cameraObject = new GameObject("Knife Evidence Camera");
            var lightObject = new GameObject("Knife Evidence Light");
            ...
            string evidenceDirectory = Path.Combine(
                ...
                "KnifeMeleeAssetMigrationEvidence");
            ...
            try
            {
                ...
                AnimationClipAsset overlay =
                    LoadAsset("KnifeOverlayPoseClipAsset.asset");
