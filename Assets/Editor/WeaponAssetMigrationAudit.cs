...
bootstrap.ConfigureWeaponDefinitions(knife, ak12);
        ...
        public static void ConfigureAk12AcceptanceLoadout()
        {
            ...
            PlayerStateDefinition playerState = AssetDatabase.LoadAssetAtPath<PlayerStateDefinition>("Assets/Settings/Gameplay/WeaponGripAK12/WeaponGripAK12PlayerStateDefinition.asset");
            ...
            if (knife == null || ak12 == null || knifeItem == null || ak12Item == null || tagSource == null || weaponTagSource == null || playerState == null || inventory == null || gameMode == null || bootstrap == null) throw new InvalidOperationException("AK12 acceptance configuration assets are missing.");
            inventory.Configure(1, knifeItem, ak12Item);
            playerState.SetInitialInventory(inventory);
