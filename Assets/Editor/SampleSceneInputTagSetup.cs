...
{
    private const string Folder = "Assets/Settings/Gameplay/SampleScene";
    private const string SourcePath = Folder + "/SampleInputTagSource.asset";
    private const string ConfigPath = Folder + "/SampleInputTagConfig.asset";
    private const string ProfilePath = Folder + "/SampleInputProfile.asset";
    ...
    private static void Configure()
    {
        ...
        PawnDefinition pawn = AssetDatabase.LoadAssetAtPath<PawnDefinition>(Folder + "/SamplePawnData.asset");
        ...
        InputTagConfig config = CreateOrLoadConfig(actions, fire, reload, melee);
    ...
    private static GameplayTagSource CreateOrLoadSource()
    {
        ...
        source.SetDefinition("SampleInput", new[]
        {
            new GameplayTagSourceNode("InputTag", false, children: new[]
            {
                ...
                {
                    new GameplayTagSourceNode("Fire", true), new GameplayTagSourceNode("Reload", true), new GameplayTagSourceNode("Melee", true)
                })
            })
        });
    ...
    private static InputTagConfig CreateOrLoadConfig(InputActionAsset actions, GameplayTag fire, GameplayTag reload, GameplayTag melee)
    {
