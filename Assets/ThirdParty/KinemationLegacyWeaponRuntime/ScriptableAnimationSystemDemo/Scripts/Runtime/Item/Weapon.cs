...
using CGame.KinemationLegacyWeaponRuntime.KINEMATION.FPSAnimationFramework.Runtime.Camera;
...
using CGame.KinemationLegacyWeaponRuntime.KINEMATION.FPSAnimationFramework.Runtime.Recoil;
using CGame.KinemationLegacyWeaponRuntime.KINEMATION.ProceduralRecoilAnimationSystem.Runtime;

using CGame.KinemationLegacyWeaponRuntime.Demo.Scripts.Runtime.AttachmentSystem;

using System.Collections.Generic;
using CGame.KinemationLegacyWeaponRuntime.Demo.Scripts.Runtime.Character;
using CGame.KinemationLegacyWeaponRuntime.KINEMATION.Shared.KAnimationCore.Runtime.Input;
using UnityEngine;

namespace CGame.KinemationLegacyWeaponRuntime.Demo.Scripts.Runtime.Item
{
